...
{ name: 'rensink_trial_list_partial.csv', path: './resources/rensink_trial_list_partial.csv' },
]});
...
pathway = 'rensink_trial_list_partial.csv';
  ...
  org_rows = [];
  for (var o = 0; o < 12; o++) {    //change 12 to 48 for full
      org_rows.push(o);
  }
...
function trials_1LoopBegin(thisScheduler) {
  ...
  trials = new TrialHandler({
    ...
    trialList: TrialHandler.importConditions(psychoJS.serverManager, 'rensink_trial_list_partial.csv', prac_trial_rows),
