...
{ name: 'wolfe2_semantic_final_descriptions_partial.csv', path: './resources/wolfe2_semantic_final_descriptions_partial.csv' },
]});
...
function trialsLoopBegin(thisScheduler) {
  ...
  trials = new TrialHandler({
    ...
    trialList: 'wolfe2_semantic_final_descriptions_partial.csv',
