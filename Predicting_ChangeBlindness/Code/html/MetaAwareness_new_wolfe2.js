...
{ name: 'wolfe2_L_trial_list.csv', path: './resources/wolfe2_L_trial_list.csv' },
{ name: 'wolfe2_R_trial_list.csv', path: './resources/wolfe2_R_trial_list.csv' },
]});
...
//    }
    ...
    var x = ['wolfe2_L_trial_list.csv', 'wolfe2_R_trial_list.csv'];
...
//    }
  ...
  trials = new TrialHandler({
    ...
    trialList: TrialHandler.importConditions(psychoJS.serverManager, pathway, prac_trial_rows),
