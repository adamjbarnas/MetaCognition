...
{ name: 'A10MSB9X1UFLJ5_trial_list.csv', path: './resources/A10MSB9X1UFLJ5_trial_list.csv' },
{ name: 'A171RZ3O028XF6_trial_list.csv', path: './resources/A171RZ3O028XF6_trial_list.csv' },
{ name: 'A1ESQQT4HBLB52_trial_list.csv', path: './resources/A1ESQQT4HBLB52_trial_list.csv' },
{ name: 'A1G187YBG0DVMQ_trial_list.csv', path: './resources/A1G187YBG0DVMQ_trial_list.csv' },
{ name: 'A1GKD3NG1NNHRP_trial_list.csv', path: './resources/A1GKD3NG1NNHRP_trial_list.csv' },
{ name: 'A1GS7LBNOKOIPI_trial_list.csv', path: './resources/A1GS7LBNOKOIPI_trial_list.csv' },
{ name: 'A1NR3COO33J99C_trial_list.csv', path: './resources/A1NR3COO33J99C_trial_list.csv' },
{ name: 'A1PY8ZXYIJYLQO_trial_list.csv', path: './resources/A1PY8ZXYIJYLQO_trial_list.csv' },
{ name: 'A1QC1K71RGKZBI_trial_list.csv', path: './resources/A1QC1K71RGKZBI_trial_list.csv' },
{ name: 'A1QUBLZCONL4QD_trial_list.csv', path: './resources/A1QUBLZCONL4QD_trial_list.csv' },
{ name: 'A1RJIOHZFBH3GJ_trial_list.csv', path: './resources/A1RJIOHZFBH3GJ_trial_list.csv' },
{ name: 'A1WPCXNFENBSY4_trial_list.csv', path: './resources/A1WPCXNFENBSY4_trial_list.csv' },
{ name: 'A1YV6W4EZP9T4Q_trial_list.csv', path: './resources/A1YV6W4EZP9T4Q_trial_list.csv' },
{ name: 'A26L0OBAWF7EHQ_trial_list.csv', path: './resources/A26L0OBAWF7EHQ_trial_list.csv' },
{ name: 'A28HDBWFTOID89_trial_list.csv', path: './resources/A28HDBWFTOID89_trial_list.csv' },
{ name: 'A2AM62BHO8G9MB_trial_list.csv', path: './resources/A2AM62BHO8G9MB_trial_list.csv' },
{ name: 'A2GOS6NF74E2ST_trial_list.csv', path: './resources/A2GOS6NF74E2ST_trial_list.csv' },
{ name: 'A2JDYN6QM8M5UN_trial_list.csv', path: './resources/A2JDYN6QM8M5UN_trial_list.csv' },
{ name: 'A2V4DP31BEVABF_trial_list.csv', path: './resources/A2V4DP31BEVABF_trial_list.csv' },
{ name: 'A2XCEMBRPHIWEG_trial_list.csv', path: './resources/A2XCEMBRPHIWEG_trial_list.csv' },
{ name: 'A2Y4UMAUYJM9GK_trial_list.csv', path: './resources/A2Y4UMAUYJM9GK_trial_list.csv' },
{ name: 'A33AZCOKCCTUXV_trial_list.csv', path: './resources/A33AZCOKCCTUXV_trial_list.csv' },
{ name: 'A3C1L496HD22M7_trial_list.csv', path: './resources/A3C1L496HD22M7_trial_list.csv' },
{ name: 'A3G6L97AX9KR7F_trial_list.csv', path: './resources/A3G6L97AX9KR7F_trial_list.csv' },
{ name: 'A3GUUW46FNRMS3_trial_list.csv', path: './resources/A3GUUW46FNRMS3_trial_list.csv' },
{ name: 'A3HQJM4EQ9WQ5L_trial_list.csv', path: './resources/A3HQJM4EQ9WQ5L_trial_list.csv' },
{ name: 'A3RYI5HXC2MJLN_trial_list.csv', path: './resources/A3RYI5HXC2MJLN_trial_list.csv' },
{ name: 'A4WBW7FVQASZE_trial_list.csv', path: './resources/A4WBW7FVQASZE_trial_list.csv' },
{ name: 'A50CXIIWYK9BP_trial_list.csv', path: './resources/A50CXIIWYK9BP_trial_list.csv' },
{ name: 'A6HDSE80LQPR8_trial_list.csv', path: './resources/A6HDSE80LQPR8_trial_list.csv' },
{ name: 'ADAL2H41ZBWAK_trial_list.csv', path: './resources/ADAL2H41ZBWAK_trial_list.csv' },
{ name: 'AGRKG3YT3KMD8_trial_list.csv', path: './resources/AGRKG3YT3KMD8_trial_list.csv' },
{ name: 'AKG7VBOY97HKA_trial_list.csv', path: './resources/AKG7VBOY97HKA_trial_list.csv' },
{ name: 'ALDQRWYZ8KQ9A_trial_list.csv', path: './resources/ALDQRWYZ8KQ9A_trial_list.csv' },
{ name: 'ANYJ22IOQKAX3_trial_list.csv', path: './resources/ANYJ22IOQKAX3_trial_list.csv' },
{ name: 'AP4A0MZOKR52J_trial_list.csv', path: './resources/AP4A0MZOKR52J_trial_list.csv' },
{ name: 'APKFFVZKZJ6NZ_trial_list.csv', path: './resources/APKFFVZKZJ6NZ_trial_list.csv' },
{ name: 'APO6KZZ79PO9Q_trial_list.csv', path: './resources/APO6KZZ79PO9Q_trial_list.csv' },
{ name: 'APS21FRK7TBKW_trial_list.csv', path: './resources/APS21FRK7TBKW_trial_list.csv' },
{ name: 'ARI1EMAHUA9PO_trial_list.csv', path: './resources/ARI1EMAHUA9PO_trial_list.csv' },
{ name: 'ATOMAIZXIR31I_trial_list.csv', path: './resources/ATOMAIZXIR31I_trial_list.csv' },
{ name: 'AU7A3QNJF3O00_trial_list.csv', path: './resources/AU7A3QNJF3O00_trial_list.csv' },
{ name: 'AV7OKGJ2PJO30_trial_list.csv', path: './resources/AV7OKGJ2PJO30_trial_list.csv' },
{ name: 'AZ69TBTDH7AZS_trial_list.csv', path: './resources/AZ69TBTDH7AZS_trial_list.csv' },
{ name: 'rensink_trial_list.csv', path: './resources/rensink_trial_list.csv' },
]});
...
function experimentInit() {
  ...
  OpeningText = new visual.TextStim({
    ...
    var obj = ['A10MSB9X1UFLJ5', 'A171RZ3O028XF6', 'A1ESQQT4HBLB52', 'A1G187YBG0DVMQ', 'A1GKD3NG1NNHRP', 'A1GS7LBNOKOIPI', 'A1NR3COO33J99C', 'A1PY8ZXYIJYLQO', 'A1QC1K71RGKZBI', 'A1QUBLZCONL4QD', 'A1RJIOHZFBH3GJ', 'A1WPCXNFENBSY4', 'A1YV6W4EZP9T4Q', 'A26L0OBAWF7EHQ', 'A28HDBWFTOID89', 'A2AM62BHO8G9MB', 'A2GOS6NF74E2ST', 'A2JDYN6QM8M5UN', 'A2V4DP31BEVABF', 'A2XCEMBRPHIWEG', 'A2Y4UMAUYJM9GK', 'A33AZCOKCCTUXV', 'A3C1L496HD22M7', 'A3G6L97AX9KR7F', 'A3GUUW46FNRMS3', 'A3HQJM4EQ9WQ5L', 'A3RYI5HXC2MJLN', 'A4WBW7FVQASZE', 'A50CXIIWYK9BP', 'A6HDSE80LQPR8', 'ADAL2H41ZBWAK', 'AGRKG3YT3KMD8', 'AKG7VBOY97HKA', 'ALDQRWYZ8KQ9A', 'ANYJ22IOQKAX3', 'AP4A0MZOKR52J', 'APKFFVZKZJ6NZ', 'APO6KZZ79PO9Q', 'APS21FRK7TBKW', 'ARI1EMAHUA9PO', 'ATOMAIZXIR31I', 'AU7A3QNJF3O00', 'AV7OKGJ2PJO30', 'AZ69TBTDH7AZS'];
    if (Object.values(obj).indexOf(expInfo['worker_ID']) > -1) {
        infile = (String(expInfo['worker_ID']) + '_trial_list.csv');
        pathway = infile;
    } else{
        pathway = 'rensink_trial_list.csv';
    }
