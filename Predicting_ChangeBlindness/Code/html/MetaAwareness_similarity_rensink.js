...
{ name: 'rensink_semantic_final_descriptions_partial.csv', path: './resources/rensink_semantic_final_descriptions_partial.csv' },
]});
...
function trialsLoopBegin(thisScheduler) {
  ...
  trials = new TrialHandler({
    ...
    trialList: 'rensink_semantic_final_descriptions_partial.csv',
