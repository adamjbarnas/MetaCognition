...
{ name: 'ma_semantic_final_descriptions_partial.csv', path: './resources/ma_semantic_final_descriptions_partial.csv' },
]});
...
function trialsLoopBegin(thisScheduler) {
  ...
  trials = new TrialHandler({
    ...
    trialList: 'ma_semantic_final_descriptions_partial.csv',
