...
{ name: 'wolfe2_L_trial_list_partial.csv', path: './resources/wolfe2_L_trial_list_partial.csv' },
{ name: 'wolfe2_R_trial_list_partial.csv', path: './resources/wolfe2_R_trial_list_partial.csv' },
]});
...
function experimentInit() {
  ...
  OpeningText = new visual.TextStim({
    ...
    var x = ['wolfe2_L_trial_list_partial.csv', 'wolfe2_R_trial_list_partial.csv'];
  ...
  org_rows = [];
if (pathway === 'wolfe2_L_trial_list_partial.csv') {
  for (var o = 0; o < 15; o++) {
      org_rows.push(o);
  }
} else if (pathway === 'wolfe2_R_trial_list_partial.csv') {
    for (var o = 0; o < 14; o++) {
      org_rows.push(o);
  }
}
